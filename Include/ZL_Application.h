...
#if (defined(__ANDROID__) || defined(__IPHONEOS__) || defined(__WEBAPP__) || ((defined(linux) || defined(__linux) || defined(__linux__)) && (defined(__arm__) || defined(__aarch64__)))) && !defined(ZL_VIDEO_OPENGL_ES1) && !defined(ZL_VIDEO_OPENGL_ES2) && !defined(ZL_VIDEO_OPENGL1) && !defined(ZL_VIDEO_OPENGL2) && !defined(ZL_VIDEO_OPENGL_CORE)
//#define ZL_VIDEO_OPENGL_ES1
#define ZL_VIDEO_OPENGL_ES2
#elif !defined(__WINDOWSPHONE__) && !defined(ZL_VIDEO_OPENGL_ES1) && !defined(ZL_VIDEO_OPENGL_ES2) && !defined(ZL_VIDEO_OPENGL1) && !defined(ZL_VIDEO_OPENGL2) && !defined(ZL_VIDEO_OPENGL_CORE)
//#define ZL_VIDEO_OPENGL1
#define ZL_VIDEO_OPENGL2
//#define ZL_VIDEO_OPENGL_CORE
#endif
#if (defined(ZL_VIDEO_OPENGL_ES1)+defined(ZL_VIDEO_OPENGL_ES2)+defined(ZL_VIDEO_OPENGL1)+defined(ZL_VIDEO_OPENGL2)+defined(ZL_VIDEO_OPENGL_CORE)) != 1
